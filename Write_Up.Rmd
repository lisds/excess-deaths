...
plt.bar(x=excess_mortality.index, height=excess_mortality['Mean 2023'])
...
The only vaccine types with a sufficient amounts of datato justify further analysis are Astrazeneca, Pfizer, Janssen and Moderna. 
...
for x, y, country in zip(vaccine_dict['Pfizer']['% vaxed'],
    ...
    axs[1, 0].scatter(x, y)
    axs[1, 0].text(x, y, country, fontsize=8, ha='right', va='bottom')  
...
for x, y, country in zip(vaccine_dict['Janssen']['% vaxed'],
    ...
    axs[1, 1].scatter(x, y)
    axs[1, 1].text(x, y, country, fontsize=8, ha='right', va='bottom')  
...
```{python}
sps.linregress(no_LI['% vaxed'], no_LI['Mean 2023'])
```
