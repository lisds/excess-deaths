...
- check we are using excess death and excess mortality correctly throughout - different definitions
...
- What is important to contextualise the data - mean excess mortality across countries, max and min death and vaccination rate etc
